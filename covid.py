...
countries = ['Mainland China', 'Italy', 'US']
                    ...
                    if lookNext == True:
                        ...
                        if line[:23] == '<td class="text-right">':
                            ...
                            if country_string == 'Mainland China':
                                ...
                                if firstRound:
                                    coronainfo['us_inf'] = number_string
                                else:
                                    coronainfo['us_dead'] = number_string
...
def dataWriter(monitor, updateall=False,daily=False,semi_often=False):
    ...
    if semi_often:
        ...
        monitor.addstr(33,1,"US          |            |        |", curses.A_BOLD)
        ...
        monitor.addstr(33,25-len(coronainfo['us_inf']),coronainfo['us_inf'])
        ...
        monitor.addstr(33,34-len(coronainfo['us_dead']),coronainfo['us_dead'])
